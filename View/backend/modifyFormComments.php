...
<div class="formStyle">
    <form action="index.php?action=editComment" method="post">
    	...
    	<input name="id_comment" type="hidden" value="<?php echo htmlspecialchars($comment['id_post']); ?>"/ >
        <div>
            <label for="content">Commentaire *</label><br />
			<textarea id="content" name="content" required><?php echo htmlspecialchars($comment['content']); ?></textarea><br />
