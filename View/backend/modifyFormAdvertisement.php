...
?>
				<option value="<?php echo htmlspecialchars($category['id']); ?>" <?php if ($category['id'] == $ad['id_category']) { echo 'selected'; } ?>><?php echo htmlspecialchars($category['name']); ?></option>
<?php
}
?>
			</select><br />
        	<label for="title">Intitulé *</label><br />
            <input type="text" id="title" name="title" required value="<?php echo htmlspecialchars($ad['title']); ?>"/><br />
            <label for="town">Ville *</label><br />
            <input type="text" id="town" name="town" required value="<?php echo htmlspecialchars($ad['town']); ?>" /><br />
            <label for="location">Département *</label><br />
            <input type="number" min="01" max="99" id="county" name="county" required value="<?php echo htmlspecialchars($ad['county']); ?>"/><br />
            <label for="location">Emplacement précis</label><br />
            <input type="text" id="location" name="location" value="<?php echo htmlspecialchars($ad['location']); ?>"/><br />
			<label for="date">Date</label><br />
	        <input type="date" name="date_event" value="<?php echo htmlspecialchars($ad['date_event']); ?>"/><br />
            <label for="content">Contenu *</label><br />
			<textarea id="content" name="content" required><?php echo htmlspecialchars($ad['content']); ?></textarea><br />
