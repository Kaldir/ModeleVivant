...
<div class="container-fluid homeContainer">
	<div class="row homeRow">
		...
		<div class="homeBlocks col-md-6 col-lg-4" id="homeIntro">
		...
		<div class="homeBlocks col-md-6 col-lg-4">
            ...
            <div class="formStyle fsContentResponsive homeStyle">
				...
				<div class="homeLink">
					<a href="index.php?action=posts" class="buttonStyle arrow"><i class="fas fa-arrow-right"></i></a>
				</div>
			</div>
		</div>
		...
		<div class="homeBlocks col-md-6 col-lg-4">	
			...
			<div class="formStyle fsContentResponsive homeStyle">
				...
				<div class="homeLink">
					<a href="index.php?action=marketplace" class="buttonStyle arrow"><i class="fas fa-arrow-right"></i></a>
				</div>
			</div>
		</div>
		...
		<div class="homeBlocks col-md-6 col-lg-4">	
			...
			<div class="formStyle fsContentResponsive homeStyle">
				...
				<div class="homeLink">
					<a href="index.php?action=advertisements" class="buttonStyle arrow"><i class="fas fa-arrow-right"></i></a>
				</div>
			</div>
		</div>
		...
		<div class="homeBlocks col-md-6 col-lg-4">	
			...
			<div class="formStyle fsContentResponsive homeStyle">
				...
				<div class="homeLink">
					<a href="index.php?action=friends" class="buttonStyle arrow"><i class="fas fa-arrow-right"></i></a>
				</div>
			</div>
		</div>
		...
		<div class="homeBlocks col-md-6 col-lg-4">	
			...
			<div class="formStyle fsContentResponsive homeStyle">
				...
				<div class="homeLink">
					<a href="index.php?action=contact" class="buttonStyle arrow"><i class="fas fa-arrow-right"></i></a>
				</div>
			</div>
		</div>
	</div>
